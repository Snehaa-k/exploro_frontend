...
const AdminHome = () => {
  ...
  return (
    ...
    <div style={{backgroundColor:'#BFE8FF',width:'100%',height:'200px'}}>
    {selectedMenuItem === 'Dashboard' && (
          <Typography variant='h5' style={{ marginLeft: '370px', paddingTop: '50px' }}>Welcome to the Dashboard</Typography>
        )}
        {selectedMenuItem === 'Travellers' && (
          <Typography variant='h5' style={{ marginLeft: '370px', paddingTop: '50px' }}>Traveller Information</Typography>
        )}
        {selectedMenuItem === 'TraveLeaders' && (
          <Typography variant='h5' style={{ marginLeft: '370px', paddingTop: '50px' }}>Travel Leaders Information</Typography>
        )}
