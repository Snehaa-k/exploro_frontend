      ...
      <div>
        ...
        >
          <Table aria-label="simple table">
            <TableHead>
              <TableRow>
                <TableCell style={{ fontWeight: 'bold' }}>Reporter Name</TableCell>
                <TableCell style={{ fontWeight: 'bold' }}>Reporter Email</TableCell>
                <TableCell style={{ fontWeight: 'bold' }}>Reported User Name</TableCell>
                <TableCell style={{ fontWeight: 'bold' }}>Reported User Email</TableCell>
