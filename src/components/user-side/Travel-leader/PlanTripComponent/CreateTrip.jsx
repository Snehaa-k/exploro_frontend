...
const CreateTrip = () => {
  ...
  const validationSchema = Yup.object({
    ...
    duration: Yup.number().required('Please add duration').min(1, 'Duration must be at least 1 day'),
    ...
    amount: Yup.number().required('Please add amount').min(1, 'Amount must be at least ₹1'),
    participant_limit: Yup.number().required('Please add participant limit').min(1, 'At least one participant required'),
      ...
      {({ setFieldValue, values, isSubmitting }) => {
        useEffect(() => {
          if (values.start_date && values.duration) {
            setFieldValue('end_date', calculateEndDate(values.start_date, values.duration));
          }
          ...
          <Form className="trip-container">
            <Grid container spacing={2} justifyContent="center">
              <Grid item xs={12} md={4}>
                ...
                <ErrorMessage name="Trip_image" component="div" className="error-message" />
              </Grid>
              ...
              <Grid item xs={12} sm={6} md={4}>
                <Field
                  ...
                  variant="outlined"
                  margin="normal"
                  helperText={<ErrorMessage name="trip_type" component="div" className="error-message" />}
                >
