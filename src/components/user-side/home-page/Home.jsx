  ...
  return (
    <div className="container">
      <div className="container1">
        ...
        {(mode === "role-selection") | "userpreference" ? (
          ""
        ) : (
          <Button
        ...
        <p className="description">
          Discover the world like never before! Explore hidden gems, find your
          next adventure, and connect with fellow travelers.
          <br />
          Your journey starts here.
        </p>
      </div>
      <div className="container2">
        <div className="container3">{renderContent()}</div>
      </div>
    </div>
  );
};
