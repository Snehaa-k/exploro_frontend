...
import { Box, Paper, Avatar, Typography, List, ListItem, ListItemIcon, ListItemText, Badge } from '@mui/material';
import MailIcon from '@mui/icons-material/Mail';
import NotificationsIcon from '@mui/icons-material/Notifications';
import './RightSide.css';

const Sidebar = ({ profileImage, name, role, bio, menuItems,notificationCount,chatCount }) => {
  return (
    <Box
      p={2}
      sx={{
